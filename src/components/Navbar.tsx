  ...
  return (
    <div className="h-[60px] flex items-center w-full justify-between sticky top-0 bg-[#efefef] z-[10]">
      ...
      <div className="flex items-center gap-10">
        <Link href={"/"}>
          <Image src="/logo.png" alt="Fayz logo" width={40} height={40} />
        </Link>
        <ul className="flex items-center gap-6 max-sm:hidden">
          <Link href={"/"}>
            <li
              className={`cursor-pointer font-extrabold text-[14px] ${pathname === "/" && "text-[#01A3D4]"
                }`}
            >
              Biz haqimizda
            </li>
          ...
          <Link href={"/Markets"}>
            <li
              className={`cursor-pointer font-extrabold text-[14px] ${pathname === "/Markets" && "text-[#01A3D4]"
                }`}
            >
              Do&apos;konlar
            </li>
          ...
          <Link href={"/News"}>
            <li
              className={`cursor-pointer font-extrabold text-[14px] ${pathname === "/News" && "text-[#01A3D4]"
                }`}
            >
              Yangiliklar
            </li>
          ...
          <Link href={"/Contacts"}>
            <li
              className={`cursor-pointer font-extrabold text-[14px] ${pathname === "/Contacts" && "text-[#01A3D4]"
                }`}
            >
              Aloqa
            </li>
