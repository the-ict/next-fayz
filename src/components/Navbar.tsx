    ...
    <div className='h-[60px] flex items-center w-full justify-between sticky top-0 bg-[#efefef] z-99'>
            ...
            <div className='px-2 py-5 h-full w-[30%] bg-[#efefef] rounded-2xl navbar transition-all flex flex-col justify-between'>
              <div className='text-[20px] font-bold'>
                ...
                <ul className='flex flex-col gap-4 mt-10'>
                  <Link href={"/"}>
                    <li className={`${pathname === "/" && "text-[#01A3D4]"}`}>Biz haqimizda</li>
                  </Link>
                  <Link href={"/Markets"}>
                    <li className={`${pathname === "/Markets" && "text-[#01A3D4]"}`}>Do'konlar</li>
                  </Link>
                  <Link href={"/News"}>
                    <li className={`${pathname === "/News" && "text-[#01A3D4]"}`}>Yangiliklar</li>
                  </Link>
                  <Link href={"/Contacts"}>
                    <li className={`${pathname === "/Contacts" && "text-[#01A3D4]"}`}>Aloqa</li>
                  </Link>
                </ul>
              </div>
              <button className='bg-blue-600 p-2 text-white font-bold rounded outline-none border-none'>Bo'g'lanish</button>
            </div>
          </div>
        )
      }
      ...
      <div className='flex items-center gap-10'>
        ...
        <ul className='flex items-center gap-6 max-sm:hidden'>
          <Link href={"/"}>
            <li className={`cursor-pointer font-extrabold text-[14px] ${pathname === "/" && "text-[#01A3D4]"}`}>Biz haqimizda</li>
          </Link>
          <Link href={"/Markets"}>
            <li className={`cursor-pointer font-extrabold text-[14px] ${pathname === "/Markets" && "text-[#01A3D4]"}`}>Do'konlar</li>
          </Link>
          <Link href={"/News"}>
            <li className={`cursor-pointer font-extrabold text-[14px] ${pathname === "/News" && "text-[#01A3D4]"}`}>Yangiliklar</li>
          </Link>
          <Link href={"/Contacts"}>
            <li className={`cursor-pointer font-extrabold text-[14px] ${pathname === "/Contacts" && "text-[#01A3D4]"}`}>Aloqa</li>
          </Link>
        </ul>
      </div>
