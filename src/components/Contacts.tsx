...
export default function Contacts() {
    ...
    return (
        <div className='bg-[#fdfdfd] mt-10 flex flex-col items-center justify-center p-10 animation-block dark:bg-[#111111]'>
            ...
            <form className="flex flex-col gap-4 mt-3 w-[400px] max-sm:w-full " onSubmit={(e) => e.preventDefault()}>
                ...
                <textarea
                    ...
                    className='h-[200px] p-3 bg-[#EFEFEF] rounded border-none outline-none dark:text-black' placeholder='Savolingizni kiriting!'></textarea>
                <button
                    onClick={handleEmail}
